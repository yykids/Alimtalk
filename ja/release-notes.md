...
### 2019.04.23
* [Console] 알림톡 대량 발송, 대체발송 지정 기능 추가
    - 알림톡 대량 발송 시, 대체발송 내용/발신번호/대체발송 여부 등 대체발송 관련 필드를 지정할 수 있는 기능이 추가되었습니다.
* [Console] 알림톡 대량 발송, 분할 발송 기능 추가
    - 알림톡 대량 발송 시, 분할 횟수/시간 간격을 지정하여 분할 발송할 수 있는 기능이 추가되었습니다.
* [Console] 알림톡/친구톡 대체발송 설정 분리
    - 알림톡/친구톡 각각의 플러스친구에 대체발송 설정을 할 수 있는 기능이 추가되었습니다.
    ex) 동일한 플러스친구에서 알림톡만 대체발송 설정 시, 친구톡은 발송 실패하여도 대체발송 되지 않습니다.
* [Console] 플러스친구 등록 시, 비지니스 인증 도입
    - 플러스친구 등록 시 플러스친구의 "비즈니스 인증"된 경우만 등록 가능하도록 변경됩니다.​ [[관련 공지사항](https://center-pf.kakao.com/notices/311)]
* [Console] 템플릿 선택 모달창에서 like 검색 기능 추가
    - 템플릿 선택 모달창에서 손쉽게 템플릿을 선택할 수 있도록 like 검색 기능이 추가되었습니다. (템플릿코드, 템플릿명으로 검색)
* [API] 광고 친구톡, 광고 SMS API로 대체발송 되도록 개선
    - 광고 친구톡 발송 실패 시, 광고 SMS API로 대체발송 되도록 개선되었습니다.
    - 광고 친구톡 대체 발송 설정 시, 080수신거부를 반드시 등록해야 정상적으로 대체발송 됩니다.
