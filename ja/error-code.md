...
| 공통 | false | -1014 | 유효하지 않은 사업자등록 번호 |
| 공통 | false | -1016 | 메시지를 찾을 수 없을 경우 |
| 공통 | false | -1017 | 일별 발송량을 초과한 발송 실패 |
| 공통 | false | -1018 | 사업자등록증 파일이 존재하지 않을 경우 |
| 공통 | false | -2000 | 특정 필드 값이 최대 길이 보다 클 경우 |
| 공통 | false | -2001 | 특정 필드 값이 공백일 경우 |
| 공통 | false | -2002 | 특정 필드 값이 NULL일 경우 |
| 공통 | false | -2003 | 특정 필드 값이 최소 길이 보다 작을 경우 |
...
| 공통 | false | -2021 | 모바일 링크/웹 링크(limkMo/linkPc) 200글자 초과 실패 |
...
| 공통 | false | -2502 | 대체 발송 설정이 되어 있지 않고, 대체 발송을 요청했을 경우 |
| 공통 | false | -2999 | 발송 요청한 모든 수신자 요청 실패 |
| 공통 | false | -3000 | 웹링크 버튼일 경우, 모바일 링크(linkMo)는 필수 값입니다 |
...
| 공통 | false | -3007 | 앱 링크 버튼일 경우, 앱링크(schemeAndroid/schemeIos)는 필수 값입니다 |
| 공통 | false | -3008 | 버튼명에 템플릿 치환자를 입력할 수 없습니다 |
...
| 공통 | false | -9995 | fade-out 된 버전의 API를 호출했을 경우 |
