...
| 공통      | false     | -2000      | 특정 필드값이 최대 길이보다 클 경우 |
| 공통      | false     | -2001      | 특정 필드값이 공백일 경우 |
| 공통      | false     | -2002      | 특정 필드값이 NULL일 경우 |
| 공통      | false     | -2003      | 특정 필드값이 최소 길이보다 작을 경우 |
| 공통      | false     | -2020      | 버튼명 14글자 초과로 실패                          |
| 공통      | false     | -2021      | 모바일 링크/웹 링크(limkMo/linkPc) 100글자 초과로 실패  |
...
| 공통      | false     | -3000      | 자유 버튼 타입의 템플릿일 경우, 버튼명/모바일 링크(linkMo)는 필숫값입니다. |
...
| 공통      | false     | -4006      | 기본 발신 프로필이 등록되지 않은 앱키                    |
...
| 공통      | false     | -5001      | 발송 시, 수신자 목록가 없을 경우                      |
...
<tbody>
  ...
  <tr>
	...
	<tr>
		<td>1006</td>
		<td>삭제된 발신프로필. (메시지 사업 담당자에게 문의)</td>
	</tr>
	<tr>
		<td>1007</td>
		<td>차단 상태의 발신프로필. (메시지 사업 담당자에게 문의)</td>
	</tr>
	<tr>
		<td>1011</td>
		<td>계약정보를 찾을 수 없음. (메시지 사업 담당자에게 문의)</td>
	</tr>
  <tr>
		<td>1012</td>
		<td>잘못된 형식의 유저키 요청</td>
	</tr>
  <tr>
		<td>1013</td>
		<td>유효하지 않은 app연결</td>
  ...
  <tr>
	...
	<tr>
		<td>2004</td>
		<td>템플릿 일치 확인시 오류 발생(내부 오류 발생)</td>
	</tr>
	<tr>
		<td>3000</td>
		<td>예기치 않은 오류 발생</td>
	...
	<tr>
		<td>3005</td>
		<td>메시지를 발송했으나 수신확인 안됨 (성공불확실, 서버에는 암호화 되어 보관되며 3일 이내 수신 가능)</td>
	</tr>
	<tr>
		<td>3006</td>
	...
	<tr>
		<td>3026</td>
		<td>메시지와 템플릿의 일치성 확인 시 오류 발생</td>
	</tr>
	<tr>
		<td>3027</td>
	...
	<tr>
		<td>3041</td>
		<td>Request Body에서 Name을 찾을 수 없음</td>
	</tr>
	<tr>
		<td>3042</td>
  ...
  <tr>
		<td>3060</td>
		<td>사용자에게 발송하였으나 수신 여부 불투명(Polling)</td>
	</tr>
	<tr>
		<td>4000</td>
		<td>메시지 전송 결과를 찾을 수 없음</td>
  ...
  <tr>
	...
	<tr>
		<td>E920</td>
		<td>서비스 타입이 알림톡인 경우, 메시지 테이블에 파일 그룹 키가 있는 경우</td>
	</tr>
	<tr>
		<td>E999</td>
		<td>기타 오류</td>
